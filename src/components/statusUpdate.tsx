...
export function StatusUpdate({ playerName, injury, dayOfWeek, middleSlug, endSlug = '' }: TweetProps) {
	...
	return (
		<Card variant="outlined">
			<Stack direction="row" alignItems="center" justifyContent="space-between" minHeight={30} py={1} px={2}
						 spacing={2}>
