	...
	return (
		<Box>
			<Stack spacing={1}>
				...
				<StatusUpdate playerName={playerName} injury={injury} dayOfWeek={dayOfWeek} middleSlug="in locker room" />
				...
				<StatusUpdate playerName={playerName} injury={injury} dayOfWeek={dayOfWeek} middleSlug="available to return" />
				<StatusUpdate playerName={playerName} injury={injury} dayOfWeek={dayOfWeek} middleSlug="probable to return" />
				<StatusUpdate playerName={playerName} injury={injury} dayOfWeek={dayOfWeek} middleSlug="will return" />
				<StatusUpdate playerName={playerName} injury={injury} dayOfWeek={dayOfWeek} middleSlug="expected to return" />
				<StatusUpdate playerName={playerName} injury={injury} dayOfWeek={dayOfWeek}
											middleSlug="questionable to return" />
				<StatusUpdate playerName={playerName} injury={injury} dayOfWeek={dayOfWeek} middleSlug="doubtful to return" />
